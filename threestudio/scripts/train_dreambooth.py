...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="The optional `class_label` conditioning to pass to the unet, available values are `timesteps`, `camera_pose`.",
    )
    parser.add_argument(
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.instance_images_path = [img for img in self.instance_images_path if str(img).endswith("png")]
...
def model_has_vae(args):
    ...
    if args.pretrained_model_name_or_path.startswith("DeepFloyd"):
        return False
    else:
        return True
